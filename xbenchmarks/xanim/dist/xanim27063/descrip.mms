...
#
# The following two will no longer be supported in the near future.
# BUT just in case you want to try them. This one is for DECWindows XUI
#XA_REMOTE_DEFS = -DXA_ATHENA -D_NO_PROTO
#
# And this is for DECWindows Motif v1.1 or v1.2
