...
static const char sccsid[] = "@(#)random.c	4.02 97/04/01 xlockmore";
...
/* julia maze mountain pacman slip sphere spiral strange swirl wator */
/* cartoon <XPM> */
/* gears morph3d pipes superquadrics sproingies <GL> */
#if defined( USE_XPM ) || defined( USE_XPMINC )
#define NUMXPM 1
#else
#define NUMXPM 0
#endif
#define NUMHIGHCPU (20+NUMXPM)
#ifdef USE_GL
#if USE_SPROINGIES
#define NUMGL 5
#else
...
#define DEF_DURATION	"180"	/* 0 == infinite duration */
#define DEF_MODELIST	""
...
release_random(ModeInfo * mi)
{
	if (previousmode >= 0) {
		if (MI_WIN_IS_DEBUG(mi))
			printf("releasing %s in random\n", LockProcs[previousmode].cmdline_arg);
	}
